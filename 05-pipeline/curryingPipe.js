...
const removeStopWords = (words) => (stopWordFile) => {
    let stopWords = fs.readFileSync(stopWordFile,'utf-8').split(',')
...
printTop25(sortFreqs(frequencies(removeStopWords(filterCharsAndNorm(readFile(process.argv[2])))("../stop_words.txt"))))
